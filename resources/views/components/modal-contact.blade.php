            ...
            <div class="p-4 md:p-5">
                <ul class="my-4 space-y-3">
                    @foreach ($info_company as $row)
                        @php                        
                            preg_match('/\d+/', $row->number1, $matches);
                            $numero1 = $matches[0];

                            preg_match('/\d+/', $row->number2, $matches);
                            $numero2 = $matches[0];                        

                            preg_match('/\d+/', $row->number3, $matches);
                            $numero3 = $matches[0];                        
                        @endphp
                        <li>
                            <a href="{{ $row->number1 }}" target="_blank" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                ...
                                <img src="img/whatsapp.png" alt="icon" class="h-4">
                                <span class="flex-1 ms-3 whitespace-nowrap">{{ $numero1 }}</span>                            
                        ...
                        <li>
                            <a href="{{ $row->number2 }}" target="_blank" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">                                
                                <img src="img/whatsapp.png" alt="icon" class="h-4">
                                <span class="flex-1 ms-3 whitespace-nowrap">{{ $numero2 }}</span>                  
                                <svg class="w-4 h-4 text-gray-500 ms-3 rtl:rotate-180 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>          
                            </a>
                        </li>
                        <li>
                            <a href="{{ $row->number3 }}" target="_blank" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">                                
                                <img src="img/whatsapp.png" alt="icon" class="h-4">
                                <span class="flex-1 ms-3 whitespace-nowrap">{{ $numero3 }}</span>
                                <svg class="w-4 h-4 text-gray-500 ms-3 rtl:rotate-180 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="{{ $row->facebook }}" target="_blank" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">                                
                                <img src="img/facebook.png" alt="icon" class="h-4">
                                <span class="flex-1 ms-3 whitespace-nowrap">Facebook</span>            
                                <svg class="w-4 h-4 text-gray-500 ms-3 rtl:rotate-180 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>                
                            </a>
                        </li>
                        <li>
                            <a href="{{ $row->tiktok }}" target="_blank" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">                                
                                <img src="img/trip.png" alt="icon" class="h-4">
                                <span class="flex-1 ms-3 whitespace-nowrap">Tripadvisor</span>            
                                <svg class="w-4 h-4 text-gray-500 ms-3 rtl:rotate-180 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/></svg>                
                            </a>
                        </li>
                    @endforeach

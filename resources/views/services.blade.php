                ...
                <div class="p-6">                    
                    ...
                    @isset($info_company)
                        @foreach ($info_company as $row)
                            ...
                            Para más información <button type="button" data-modal-target="crypto-modal" data-modal-toggle="crypto-modal" class="font-medium text-blue-800 hover:underline">contáctanos .</button> 
                            </p>
                        @endforeach
                    @endisset
